...
//================================================================================================================================================================================================================================================================================================================
// Функции
export function deleteMoney(count, block = '.score') {
...
export function checkRemoveAddClass(block, className, elem) {
	document.querySelectorAll(block).forEach(item => item.classList.remove(className));
	elem.classList.add(className);
}
export function noMoney(block) {
...
export function getRandom_2(min, max) {
	return +(Math.random() * (max - min) + min).toFixed(2);
}
export function addMoney(count, block, delay, delay_off) {
